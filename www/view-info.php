...
echo "<amp-img id='home-window-logo' alt='⨟' src='reading-eye-icon.jpg' width='600' height='259' layout='responsive' sizes='(min-width: 300px) 255px, 85vw' amp-fx='parallax' data-parallax-factor='1.04'></amp-img>";
...
echo "<h2 amp-fx='parallax' data-parallax-factor='1.05'>Become a publisher.</h2>";
echo "<a href='?view=register' amp-fx='parallax' data-parallax-factor='0.98'><span id='home-window-register-button'>Create account</span></a>";
echo "<p amp-fx='parallax' data-parallax-factor='0.97'>Create your account and share to the world. Our editors and translators are ready to support you. If your writing is approved, then it will be ready for publication.</p>";

echo "<amp-img id='home-window-logo' alt='⨟' src='feed-incoming-icon.jpg' width='600' height='334' layout='responsive' sizes='(min-width: 300px) 255px, 85vw' amp-fx='parallax' data-parallax-factor='1.04'></amp-img>";
