...
echo "<amp-list id='edit-window-annotations-list' max-items='10' layout='responsive' src='https://diis.online/?view=share&share=".$share_request."&action=updates&language=".$language_request."'>";
