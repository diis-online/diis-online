...
if (!(empty($share_info['content_approved']))):
	...
	echo "<div id='edit-window-approved-post-open-button' role='button' tabindex='0' on='tap: edit-window-approved-post-lightbox.open'><i class='material-icons'>visibility</i> Review approved post</div>";
...
echo "<amp-list id='edit-window-annotations-list' max-items='10' src='https://diis.online/?view=share&share=".$share_request."&action=updates&language=".$language_request."'>";
