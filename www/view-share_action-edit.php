...
if ($share_info['author_id'] == $login_status['user_id']):
	echo "<div id='edit-window-form-instructions'><p>When you finish writing, submit your work to our editors for review. We will fact-check and proofread and publish it online. If your work is rejected or if we have more questions, we will explain that in the annotations below.</p>";
