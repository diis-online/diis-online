...
echo "<span id='edit-window-submit-button' role='button' tabindex='0' on='tap:AMP.setState({content_status_state: \"submit\"}),edit-window-form-submission-alert-empty-state.hide,edit-window-form.submit'>Submit for review...</span> (This cannot be undone.)";
