...
echo "<div id='edit-window-form-submission-notice'>";
	...
	echo "<span id='edit-window-form-submission-alert-failure' submit-error><template type='amp-mustache'>Changes not synced. {{{message}}} <span id='edit-window-try-again-button' role='button' tabindex='0' on='tap:edit-window-form.submit'>Try again.</span></template></span>";
