...
if ($share_info['author_id'] == $login_status['user_id']):
	echo "<div id='edit-window-form-instructions'>When you finish writing, submit your work. Our editor will review what you wrote. After fact-checking and proofreading, we will publish it online. If your work is rejected, we will tell you why in the annotations below.<br>";
