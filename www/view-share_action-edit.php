...
// Put identifier here...
echo "<textarea name='content_draft' placeholder='Write here...' id='edit-window-draft-textarea' on='input:edit-window-form.submit' required>".$share_info['content_draft']."</textarea>";
