...
echo "<form id='create-window-form' target='_top' action-xhr='https://diis.online/?view=share&action=xhr&language=".$language_request."' method='post' on='submit-success:AMP.setState({disable: false});submit-success:AMP.setState({disable: true})'>";
