...
echo "<form id='create-window-form' target='_top' action-xhr='https://diis.online/?view=share&action=xhr&language=".$language_request."' method='post' custom-validation-reporting='as-you-go' on='valid:AMP.setState({disable: false});submit-success:AMP.setState({disable: true});submit-error:AMP.setState({disable: false})'>";
