...
// The submit button
echo "<input type='submit' id='create-window-button' on='tap:create-window-button.hide,create-window-form.submit' name='submit' value='". $translatable_elements['create-something'][$language_request] ."'>";
