...
echo "<form id='create-window-form' target='_top' action-xhr='https://diis.online/?view=share&action=xhr&language=".$language_request."' method='post' custom-validation-reporting='as-you-go' on='submit-success:AMP.setState({disable: true});submit-error:AMP.setState({disable: false})'>";
...
// The submit button
echo "<input type='submit' id='create-window-button' on='tap:AMP.setState({disable: true}),create-window-form.submit' name='submit' value='". $translatable_elements['create-something'][$language_request] ."' [disabled]='disable'>";
