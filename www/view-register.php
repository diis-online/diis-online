...
echo "<div id='register-window-name-alignment'>";
	...
	echo "<div id='register-window-name'><amp-list id='register-window-name-list' max-items='1' height='200' layout='fixed-height' reset-on-refresh='always' src='https://diis.online/?view=register&action=usernames&language=". $language_request ."'>";
...
echo "<div id='register-window-passcode-alignment'>";
	...
	echo "<amp-list id='register-window-name-list' max-items='1' height='200' layout='fixed-height' reset-on-refresh='always' src='https://diis.online/?view=register&action=passcode&language=". $language_request ."'>";
