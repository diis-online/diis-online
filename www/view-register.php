...
echo "<div id='register-window-name-alignment'>";
	...
	echo "<span id='register-window-name'>";
	echo "<amp-list max-items='1' width='200' height='180' layout='fixed-height' reset-on-refresh='always' src='https://diis.online/?view=register&action=usernames&language=". $language_request ."'>";
...
echo "<div id='register-window-passcode-alignment'>";
	...
	echo "<amp-list id='register-window-passcode' max-items='1' width='200' height='180' layout='fixed-height' reset-on-refresh='always' src='https://diis.online/?view=register&action=passcode&language=". $language_request ."'>";
