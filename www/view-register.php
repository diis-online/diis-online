...
if ($parameter_request == "administrator"):
	...
	echo "<a href=''><span id='register-window-security-key-link'>Reading this on your phone? Tap <i class='material-icons'>launch</i> here to add your key automatically.</i></span></a>";
