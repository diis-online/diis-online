...
echo "<div id='register-window-name-alignment'>";
	...
	echo "<amp-list id='register-window-name' max-items='1' width='200' height='180' layout='fixed-height' reset-on-refresh='always' src='https://diis.online/?view=register&action=usernames&language=". $language_request ."'>";
