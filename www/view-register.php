...
echo "<div id='register-window-name-alignment'>";
	...
	echo "<amp-list max-items='1' width='200' height='200' layout='responsive' reset-on-refresh='always' src='https://diis.online/?view=register&action=usernames&language=". $language_request ."'>";
