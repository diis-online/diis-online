...
echo "<h2 amp-fx='parallax' data-parallax-factor='1.2'>Unsilenced.</h2>";
...
echo "<h2 amp-fx='parallax' data-parallax-factor='1.2'>Safety first.</h2>";
...
echo "<h2 amp-fx='parallax' data-parallax-factor='1.2'>Become a publisher.</h2>";
...
echo "<h3>Ready?</h3>";
echo "<a href='?view=register'><span id='home-window-register-button' amp-fx='parallax' data-parallax-factor='1.3'>Create account</span></a>";
