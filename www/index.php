...
function body($title="Diis", $include=null) {
	...
	if (!(empty($login_status))):
		...
		echo "<template type='amp-mustache'><div id='login-hourglass-countdown' animate-in='fade-in' animate-in-duration='2s'>{{m}} minutes, {{s}} seconds left on page</div></template>";
