...
echo "<div id='feed-window-mission-alignment' amp-fx='fade-in' data-easing='ease-in' data-margin-start='15%' data-duration='1200ms'>";
...
echo "<div id='feed-window-who-we-are-alignment' amp-fx='fade-in' data-easing='ease-in' data-margin-start='15%' data-duration='1200ms'>";
...
if (empty($login_status)):
	echo "<div id='feed-window-become-a-publisher-alignment' amp-fx='fade-in' data-easing='ease-in' data-margin-start='15%' data-duration='1200ms'>";
...
echo "<div id='feed-window-safety-first-alignment' amp-fx='fade-in' data-easing='ease-in' data-margin-start='15%' data-duration='1200ms'>";
