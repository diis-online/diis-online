...
echo "<div id='feed-window-mission-alignment' amp-fx='fade-in' data-easing='ease-in-out'>";
...
echo "<div id='feed-window-who-we-are-alignment' amp-fx='fade-in' data-easing='ease-in-out'>";
...
if (empty($login_status)):
	echo "<div id='feed-window-become-a-publisher-alignment' amp-fx='fade-in' data-easing='ease-in-out'>";
...
echo "<div id='feed-window-safety-first-alignment' amp-fx='fade-in' data-easing='ease-in-out'>";
