...
json_output("failure", "<span role=\"button\" tabindex=\"0\" on=\"tap:submit-error.hide,AMP.setState({input_name: {input_name_value: '". $name_result['combined'] ."'}}),signin-window-form.submit\">Did you mean '".$name_result['combined']."'? Tap to fix.</span>");
