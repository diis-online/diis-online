...
json_output("failure", "<span role=\"button\" tabindex=\"0\" on=\"tap:signin-window-form.submit,AMP.setState({input_name: {input_name_value: '". $name_result['combined'] ."'}})\">Did you mean '".$name_result['combined']."'? Tap to fix.</span>");
